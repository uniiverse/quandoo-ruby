...
module Quandoo
  class ReservationEnquiryMessageData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'senderType')
        self.sender_type = attributes[:'senderType']
      end
    ...
    def valid?
      sender_type_validator = EnumAttributeValidator.new('String', ['MERCHANT', 'CUSTOMER'])
    ...
    def hash
      [sender_type, message, creation_date].hash
    end
