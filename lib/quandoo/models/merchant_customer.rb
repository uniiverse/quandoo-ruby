...
module Quandoo
  class MerchantCustomer
    # Identifier of the customer for the calling agent. (Agent dependent field)
    attr_accessor :id
    ...
    # The phone number of the customer. The expected format is E164 e.g. +4930120765890
    attr_accessor :phone_number

    # The locale of the customer. E.g. de_DE
    attr_accessor :locale

    # The 2 letter ISO country of the customer, e.g. DE
    attr_accessor :country

    # The requested subscriptions, e.g. QUANDOO, MERCHANT
    ...
    def hash
      [id, first_name, last_name, email_address, phone_number, locale, country, subscriptions].hash
    end
