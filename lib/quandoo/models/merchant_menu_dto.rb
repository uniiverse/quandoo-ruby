...
module Quandoo
  class MerchantMenuDto
    # ID of the menu
    attr_accessor :id

    # The name/title of the menu
    attr_accessor :name

    # Menu description
    attr_accessor :description

    # Total price for the menu
    attr_accessor :price
    ...
    def self.swagger_types
      {
        ...
        :'price' => :'String',
        :'sort_order' => :'Integer',
        :'categories' => :'Array<MerchantMenuCategoryDto>'
      }
    end
    ...
    def hash
      [id, name, description, price, sort_order, categories].hash
    end
