...
module Quandoo
  class CustomerResponse
    ...
    # 2-letter ISO country code of the customer, e.g. DE.
    ...
    def valid?
      ...
      gender_validator = EnumAttributeValidator.new('String', ['male', 'female', 'other', 'undefined'])
    ...
    def gender=(gender)
      validator = EnumAttributeValidator.new('String', ['male', 'female', 'other', 'undefined'])
    ...
    def hash
      [id, first_name, last_name, gender, email, phone_number, mobile_number, country, links, subscriptions].hash
    end
