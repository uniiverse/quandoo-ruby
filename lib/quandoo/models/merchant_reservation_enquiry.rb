...
module Quandoo
  class MerchantReservationEnquiry
    # The unique identifier of the reservation enquiry for the calling agent (Agent dependent field) or NULL if the agent identifier should be created. Optional.
    attr_accessor :id
    ...
    # The start date and time of the potential reservation. Format: yyyy-MM-ddTHH:mm:ssZ
    attr_accessor :start_date_time

    # The end date and time of the potential reservation. Format: yyyy-MM-ddTHH:mm:ssZ
    ...
    def hash
      [id, merchant_id, capacity, start_date_time, end_date_time, message].hash
    end
